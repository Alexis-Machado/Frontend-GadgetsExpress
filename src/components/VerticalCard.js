                        ...
                        return (
                            <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow'>
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <button className='text-sm text-white px-3 rounded-full bg-slate-200 py-2 animate-pulse'><strong></strong></button>
                                </div>
                            </div>
                        )
                    })
                        ...
                        return (
                            <Link to={"/product/" + product?._id} className='w-full min-w-[280px] md:min-w-[300px] max-w-[280px] md:max-w-[300px] bg-white rounded-sm shadow' onClick={scrollTop}>
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <button className='text-sm bg-blue-400 hover:bg-blue-950 text-white px-3 py-0.5 rounded-full' onClick={(e) => handleAddToCart(e, product?._id)}><strong>AGREGAR AL CARRITO</strong></button>
                                </div>
                            </Link>
                        )
                    })
